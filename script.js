  ...
  let init = function(){
    ...
    //.createElement() create a new element to be added to the HTML file. this method accepts a parameter of the element's name you wish to add.
    //to use this method, we need to first create a variable that represent the element we wish to add.

    //let btn = document.createElement( "BUTTON"); //This only creates the Element ti does not add it to the page.
